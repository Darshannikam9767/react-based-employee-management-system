    ...
    <div className="flex items-center justify-center h-screen w-screen">
      <div className="border-2 border-emerald-600 p-10 rounded-2xl">
            <form onSubmit={formHandler} className="flex flex-col  items-center justify-center">
                ...
                <button className="mt-10 text-xl bg-emerald-600 outline-none  rounded-full py-2 px-5 hover:scale-98 hover:bg-emerald-500 duration-150 hover:cursor-pointer active:scale-101 active:bg-emerald-700 shadow-sm shadow-emerald-200">Log In</button>
            </form>
      </div>
    </div>
  )
